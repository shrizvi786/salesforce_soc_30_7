...
import getContactRecords from '@salesforce/apex/MiniClipRecords.showMiniClip';

export default class MiniClipInteractions extends LightningElement {
                        ...
                        .then((result) => {
                                if (result) {
                                        ...
                                        if (this.data.length > 0) {
                                                ...
                                                if (this.data.length === 0) {
                                                        console.log('Inside the else to disable next button:::::', this.data);
