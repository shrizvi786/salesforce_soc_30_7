...
import getContactRecords from '@salesforce/apex/SocialInteractionRecords.showSocialInteraction';

export default class SocialInteractions extends LightningElement {
                                ...
                                if (result) {
                                        ...
                                        if (this.data.length > 0) {
                                                ...
                                                this.columns = Array.from(allKeys).map((column) => ({
                                                        ...
                                                        fieldName: column,
                                                        type: column === 'Media' ? 'url' : 'text',
                                                        typeAttributes: column === 'Media' ? { label: 'View', target: '_blank' } : undefined,
                                                }));
